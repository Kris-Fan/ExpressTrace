 ...
 * 查看客户详细信息
 */
public class CustomerInfoDetailActivity extends AppCompatActivity {


    String name,tel,addr,dpt,postcode,id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String oname = intent.getStringExtra("name");
        String  otelcode= intent.getStringExtra("telcode");
        String oaddr = intent.getStringExtra("addr");
        String  odpt= intent.getStringExtra("dpt");
        String opostcode = intent.getStringExtra("postcode");

        EditText edtname= findViewById(R.id.edtName);
        edtname.setText(oname);
        EditText edttelcode= findViewById(R.id.edtTelCode);
        edttelcode.setText(otelcode);
        EditText punedtaddr=findViewById(R.id.unedtAddr);
        punedtaddr.setText(oaddr);
        EditText edtdpt= findViewById(R.id.edtDpt);
        edtdpt.setText(odpt);
        EditText edtpostcode= findViewById(R.id.edtPostCode);
        edtpostcode.setText(opostcode);
...
//              展示省市区选择器
    ...
    public void save(View v){
        ...
        EditText unedtaddr=findViewById(R.id.unedtAddr);
    ...
    private boolean init(String name,String tel,String dpt,String addr,String postcode){
        ...
        String urlPath= BASE_URL+"/ExtraceSystem/updateCusInfo";
        URL url= null;
        try {
        ...
        try {
            ...
            Log.e("lala","客户update:init"+String.valueOf(code));
            if(code==200){   //与后台交互成功返回 200
                Log.e("lala","客户update:init");
                return true;
            }else{
    ...
    private void showPickerView() {// 弹出选择器
        ...
        OptionsPickerView pvOptions = new OptionsPickerBuilder(this, new OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                sheng=options1Items.get(options1).name;
