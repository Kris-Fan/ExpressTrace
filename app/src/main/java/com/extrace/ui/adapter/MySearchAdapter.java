...
import com.extrace.ui.service.FilterListener;
...
public class MySearchAdapter extends BaseAdapter implements Filterable {
    ...
    public MySearchAdapter(List<String> list, Context context, FilterListener filterListener) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.customer_info_search_item, null);
