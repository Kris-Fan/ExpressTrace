...
public class EmptyView extends LinearLayout implements View.OnClickListener {
    ...
    public static final int NETWORK_ERROR2 = 5; // 网络错误
    ...
    public void setErrorType(int type) {
        ...
        switch (type) {
            ...
            case NODATA:
                ...
                img.setImageResource(imgNoDataImage == -1 ? R.mipmap.empty_page : imgNoDataImage);
                img.setVisibility(View.VISIBLE);
                tv.setText(strNoDataContent == null ? "纳尼？木有数据" : strNoDataContent);
                tv.setVisibility(View.VISIBLE);
                setVisibility(View.VISIBLE);
                break;
            case NETWORK_ERROR:
                animProgress.setVisibility(View.GONE);
                img.setImageResource(imgErrorImage == -1 ? R.mipmap.net_work_error : imgErrorImage);
                img.setVisibility(View.VISIBLE);
                tv.setText(strErrorContent == null ? "网络异常，重新加载" : strErrorContent);
                tv.setVisibility(View.VISIBLE);
                setVisibility(View.VISIBLE);
                break;
            case NETWORK_ERROR2:
                animProgress.setVisibility(View.GONE);
                img.setImageResource(imgErrorImage == -1 ? R.mipmap.error_net_work : imgErrorImage);
                img.setVisibility(View.VISIBLE);
                tv.setText(strErrorContent == null ? "网络错误，将为您加载本地数据" : strErrorContent);
                tv.setVisibility(View.VISIBLE);
                setVisibility(View.VISIBLE);
                break;
            case HIDE_LAYOUT:
